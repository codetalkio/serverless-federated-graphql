...
require (
	...
	github.com/wundergraph/cosmo/router v0.0.0-20231205145633-c37d73839665
)
...
require (
	...
	github.com/wundergraph/graphql-go-tools/v2 v2.0.0-rc.2.0.20231204223728-80bf5986134f // indirect
